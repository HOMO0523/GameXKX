#!/usr/bin/env python3
"""Build and validate MVP hero PaperZD assets through UE MCP."""
...
ASSEMBLER = "Content/Python/gamexxk_assemble_paperzd_character.py"
...
def main() -> int:
    ...
    parser.add_argument("--report", type=Path, default=PROJECT_ROOT / "Saved" / "HarnessReports" / "gamexxk-paperzd-character-apply.json")
    ...
    try:
        ...
        report["assembly"] = parse_stdout_json(str(assemble_response.get("stdout", "")))

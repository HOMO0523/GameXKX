#!/usr/bin/env python3
"""Assemble MVP starter content through the project UE MCP toolset."""
...
ASSEMBLER = "Content/Python/gamexxk_assemble_content_assembly.py"
...
def main() -> int:
    ...
    parser.add_argument("--report", type=Path, default=PROJECT_ROOT / "Saved" / "HarnessReports" / "gamexxk-content-assembly-apply.json")

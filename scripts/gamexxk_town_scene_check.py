#!/usr/bin/env python3
"""Validate the Qingshan Inn town terrain and lighting scene through UE MCP."""
...
def main() -> int:
    ...
    parser.add_argument("--report", type=Path, default=PROJECT_ROOT / "Saved" / "HarnessReports" / "gamexxk-town-scene-check.json")

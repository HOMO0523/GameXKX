#!/usr/bin/env python3
"""Validate copied NPC character blueprints and flipbooks through UE MCP."""
...
def main() -> int:
    ...
    parser.add_argument("--report", type=Path, default=PROJECT_ROOT / "Saved" / "HarnessReports" / "gamexxk-npc-character-visual-check.json")

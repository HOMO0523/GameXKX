...
class QingshanWhiteboxConfigTests(unittest.TestCase):
    ...
    def test_canonical_contract_values(self):
        ...
        expected_plots = [
            ("BLD_L_01", "large", [-13600, -200, 300], 25, [1800, 1400, 1200], "core"),
            ("BLD_M_01", "medium", [-8200, -4700, 220], -15, [1200, 900, 800], "core"),
            ("BLD_M_02", "medium", [-10200, 600, 380], 18, [1100, 850, 750], "core"),
            ("BLD_M_03", "medium", [-16000, -700, 360], 42, [1400, 1000, 900], "bridge"),

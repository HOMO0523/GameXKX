...
SET_BONUSES = [
    ...
    ("Set.XuanJia.2", "玄甲", 2, "穿戴者", "产生护甲", "穿戴者产生的护甲提高10%。", "已批准；消费者已实装"),
    ("Set.XuanJia.4", "玄甲", 4, "穿戴者", "回合开始／首次格挡", "我方回合开始时保留50%护甲；每个敌方回合首次格挡后，追加80%攻击伤害。", "已批准；消费者已实装"),
    ("Set.XuanJia.6", "玄甲", 6, "全队唯一", "首次攻击气血伤害", "全队唯一。敌方回合首次有友方因攻击损失气血后，全体获得穿戴者40%防御的护甲；穿戴者援护其他友方各1次。", "已批准；消费者已实装"),
    ...
    ("Set.ShanHe.2", "山河", 2, "穿戴者", "首张地势牌", "每回合首次打出地势牌后，抽1张。", "已批准；消费者已实装"),
    ("Set.ShanHe.4", "山河", 4, "穿戴者", "首张地势牌", "每回合首张地势牌少耗1气；结算后，其他友方各回复2内力。", "已批准；消费者已实装"),
    ("Set.ShanHe.6", "山河", 6, "全队唯一", "我方回合开始", "全队唯一。每个我方回合开始时，由穿戴者触发1次当前地势。", "已批准；消费者已实装"),
]
...
def build_equipment_workbook(path: Path) -> dict[str, int]:
    ...
    add_table(wb, "06A_套装术语", ["术语", "玩家说明"], EQUIPMENT_GLOSSARY, {"术语": 18, "玩家说明": 60})

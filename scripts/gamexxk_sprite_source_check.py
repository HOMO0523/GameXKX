#!/usr/bin/env python3
"""Validate project-local sprite source PNGs and imported UE Texture2D assets."""
...
def main() -> int:
    ...
    parser.add_argument("--report", type=Path, default=PROJECT_ROOT / "Saved" / "HarnessReports" / "gamexxk-sprite-source-check.json")

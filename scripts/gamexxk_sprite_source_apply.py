#!/usr/bin/env python3
"""Stage and import selected MVP sprite source sheets through UE MCP."""
...
IMPORTER = "Content/Python/gamexxk_import_sprite_sources.py"
VALIDATOR = "Content/Python/gamexxk_validate_sprite_sources.py"
...
def main() -> int:
    ...
    parser.add_argument("--report", type=Path, default=PROJECT_ROOT / "Saved" / "HarnessReports" / "gamexxk-sprite-source-apply.json")

#!/usr/bin/env python3
"""Create or validate the editable BP_HeroCharacter asset through UE MCP."""
...
ASSEMBLER = "Content/Python/gamexxk_ensure_hero_character_blueprint.py"
...
def main() -> int:
    ...
    parser.add_argument("--report", type=Path, default=PROJECT_ROOT / "Saved" / "HarnessReports" / "gamexxk-hero-character-blueprint-apply.json")
    ...
    try:
        ...
        assembly = parse_stdout_json(str(assemble_response.get("stdout", "")))
        report["assembly"] = assembly
        report["ok"] = bool(assembly.get("ok"))

...
class QingshanTownPCGScriptsTests(unittest.TestCase):
    ...
    def test_mutations_are_restricted_to_managed_graph_and_prototype_map_roots(self):
        ...
        self.assertIn("/Game/GameXXK/Environment/TownPCG/B0R/", implementation)
        self.assertIn("/Game/GameXXK/Maps/Prototype/", implementation)
        self.assertIn("/Game/GameXXK/Maps/Dev/", implementation)
        self.assertIn("IsManagedGraphPath", implementation)
        self.assertIn("IsManagedPrototypeMapPath", implementation)

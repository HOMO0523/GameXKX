...
#include "Quick_RoadInteractiveTool.generated.h"


/**
 * Builder for UQuick_RoadInteractiveTool
 */
UCLASS()
class QUICK_ROAD_API UQuick_RoadInteractiveToolBuilder : public UInteractiveToolBuilder
{
	GENERATED_BODY()
...
/**
 * Property set for the UQuick_RoadInteractiveTool
 */
UCLASS(Transient)
class QUICK_ROAD_API UQuick_RoadInteractiveToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()

public:
	UQuick_RoadInteractiveToolProperties();
...
/**
 * UQuick_RoadInteractiveTool is an example Tool that allows the user to measure the 
 ...
 */
UCLASS()
class QUICK_ROAD_API UQuick_RoadInteractiveTool : public UInteractiveTool, public IClickDragBehaviorTarget
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY()
	TObjectPtr<UQuick_RoadInteractiveToolProperties> Properties;

...
void UGameXXKQuestDialogWidget::BuildProgrammaticLayout()
{
	...
	PrimaryActionTextBlock = MakeDialogText(WidgetTree, NSLOCTEXT("GameXXKQuestDialog", "Accept", "接取委托"), 18, FLinearColor::White, ETextJustify::Center);
	AcceptButton->AddChild(PrimaryActionTextBlock);

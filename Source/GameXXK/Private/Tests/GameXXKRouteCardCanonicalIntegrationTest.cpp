...
bool FGameXXKCanonicalQuestNpcSlotReplacementTest::RunTest(const FString& Parameters)
{
	...
	FGameXXKBattleRewardOption CanonicalBossOption;
	CanonicalBossOption.Kind = EGameXXKBattleRewardKind::BossCard;
	CanonicalBossOption.CardId = TEXT("Route.Boss.HuPoZhenDan");
	State.CardRun.PendingReward.Options.Add(CanonicalBossOption);
	FGameXXKBattleRewardOption CanonicalUpgradeOption;
	CanonicalUpgradeOption.Kind = EGameXXKBattleRewardKind::DeckCardUpgrade;
	CanonicalUpgradeOption.CardId = TEXT("Hero.Generic.QingFengYiShi");
	State.CardRun.PendingReward.Options.Add(CanonicalUpgradeOption);
	FGameXXKBattleRewardOption CanonicalRelicOption;
	CanonicalRelicOption.Kind = EGameXXKBattleRewardKind::Relic;
	CanonicalRelicOption.RelicId = TEXT("Relic.PaperCrane");
	State.CardRun.PendingReward.Options.Add(CanonicalRelicOption);

...
namespace GameXXKTaskNpcCatalogTest
{
	...
	constexpr FExpectedCard ExpectedCards[] = {
		...
		{TEXT("Npc.YueBai.QingYanDianDeng"), TEXT("青焰点灯"), TEXT("Npc.YueBai"), 1, 3, EGameXXKCardTargetMode::SingleEnemy},
		{TEXT("Npc.YueBai.YueBaiZhaoYe"), TEXT("幽白照夜"), TEXT("Npc.YueBai"), 1, 3, EGameXXKCardTargetMode::SingleEnemy},
		{TEXT("Npc.YueBai.CanJuanPiZhu"), TEXT("残卷批注"), TEXT("Npc.YueBai"), 1, 0, EGameXXKCardTargetMode::None},
		{TEXT("Npc.YueBai.ShanHeCanTu"), TEXT("山河残图"), TEXT("Npc.YueBai"), 1, 6, EGameXXKCardTargetMode::None},
...
bool FGameXXKTaskNpcCatalogTest::RunTest(const FString& Parameters)
{
	...
	if (QingYan)
	{
		...
		ExpectEffect(*this, QingYan->Id, QingYan->Effects, TEXT("检索未完成幽白牌"), EGameXXKCardEffectType::SearchUnfinishedTaskNpcCard, EGameXXKCardEffectTarget::CardOwner, 1);
	...
	if (YueZhao)
	{
		TestEqual(TEXT("幽白照夜 base has Mark, Burn, attack, trigger, and task search"), YueZhao->Effects.Num(), 5);
		...
		ExpectEffect(*this, YueZhao->Id, YueZhao->Effects, TEXT("检索未完成幽白牌"), EGameXXKCardEffectType::SearchUnfinishedTaskNpcCard, EGameXXKCardEffectTarget::CardOwner, 1);
	...
	if (CanJuan)
	{
		...
		ExpectEffect(*this, CanJuan->Id, CanJuan->Effects, TEXT("检索未完成幽白牌"), EGameXXKCardEffectType::SearchUnfinishedTaskNpcCard, EGameXXKCardEffectTarget::CardOwner, 1);
	...
	if (ShanHe)
	{
		...
		ExpectEffect(*this, ShanHe->Id, ShanHe->Effects, TEXT("检索未完成幽白牌"), EGameXXKCardEffectType::SearchUnfinishedTaskNpcCard, EGameXXKCardEffectTarget::CardOwner, 1);

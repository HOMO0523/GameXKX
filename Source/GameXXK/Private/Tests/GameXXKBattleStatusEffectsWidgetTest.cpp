...
bool FGameXXKBattleStatusEffectsWidgetTest::RunTest(const FString& Parameters)
{
	...
	OverflowStatuses.Add(MakeStatusStack(EGameXXKCardStatus::Momentum, 1));
	OverflowStatuses.Add(MakeStatusStack(EGameXXKCardStatus::Agility, 1));
	OverflowStatuses.Add(MakeStatusStack(EGameXXKCardStatus::Vulnerability, 1));
	OverflowStatuses.Add(MakeStatusStack(EGameXXKCardStatus::Bleed, 1));
	OverflowStatuses.Add(MakeStatusStack(EGameXXKCardStatus::Poison, 1));
	OverflowStatuses.Add(MakeStatusStack(EGameXXKCardStatus::Burn, 1));

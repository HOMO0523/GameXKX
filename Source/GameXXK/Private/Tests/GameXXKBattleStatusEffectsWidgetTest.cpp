...
bool FGameXXKBattleStatusTooltipsTest::RunTest(const FString& Parameters)
{
	...
	const TArray<FExpectedStatusTooltip> ExpectedStatuses = {
		{EGameXXKCardStatus::Momentum, TEXT("气势"), TEXT("MomentumSeal")},
		{EGameXXKCardStatus::Agility, TEXT("灵动"), TEXT("AgilityWing")},
		{EGameXXKCardStatus::Vulnerability, TEXT("破绽"), TEXT("VulnerabilityMask")},
		{EGameXXKCardStatus::Bleed, TEXT("流血"), TEXT("BleedDrop")},
		{EGameXXKCardStatus::Poison, TEXT("中毒"), TEXT("PoisonVial")},
		{EGameXXKCardStatus::Burn, TEXT("灼烧"), TEXT("BurnFlame")},
		{EGameXXKCardStatus::Mark, TEXT("标记"), TEXT("MarkTarget")},
		{EGameXXKCardStatus::Guard, TEXT("援护"), TEXT("GuardShield")},
		{EGameXXKCardStatus::DamageOverTime, TEXT("蚀伤"), TEXT("RotSpiral")},
		{EGameXXKCardStatus::CannotReceiveVulnerability, TEXT("破绽免疫"), TEXT("ImmunityTalisman")},
		{EGameXXKCardStatus::NextAttackBonus, TEXT("追击标记"), TEXT("TacticSeal")},
		{EGameXXKCardStatus::NextAttackAppliesVulnerability, TEXT("破绽追击"), TEXT("TacticSeal")},
		{EGameXXKCardStatus::NextHealingBonus, TEXT("疗愈增幅"), TEXT("TacticSeal")},
		{EGameXXKCardStatus::TerrainBonusDouble, TEXT("地势双效"), TEXT("TerrainAndRedirect")},
		{EGameXXKCardStatus::NextTerrainCardFree, TEXT("地势免耗"), TEXT("TerrainAndRedirect")},
		{EGameXXKCardStatus::NextTerrainCardEnergyReduction, TEXT("地势减耗"), TEXT("TerrainAndRedirect")},
		{EGameXXKCardStatus::RedirectSingleTargetEnemyAttack, TEXT("代挡"), TEXT("TerrainAndRedirect")},
		{EGameXXKCardStatus::TerrainBonusDoubleThisRound, TEXT("本回合地势双效"), TEXT("TerrainAndRedirect")},
		{EGameXXKCardStatus::Medicine, TEXT("药效"), TEXT("MedicineHerbs")},
		{EGameXXKCardStatus::Weak, TEXT("虚弱"), TEXT("WeakBrokenBlade")},
		{EGameXXKCardStatus::Wealth, TEXT("财富"), TEXT("WealthCoin")},
		{EGameXXKCardStatus::Rage, TEXT("狂怒"), TEXT("RageFlame")},
		{EGameXXKCardStatus::Prey, TEXT("猎物"), TEXT("PreyTargetEye")},
		{EGameXXKCardStatus::Charge, TEXT("蓄力"), TEXT("ChargeSpiralHorn")},
		{EGameXXKCardStatus::Counter, TEXT("反击"), TEXT("CounterHookBlade")},
		{EGameXXKCardStatus::Block, TEXT("格挡"), TEXT("BlockShield")},
	};
	...
	TestEqual(TEXT("armor uses one concise rule"), ArmorStyle.Tooltip, GameXXKCardPillText::DescribeTerm(TEXT("护甲")));
	TestEqual(
		...
		FString(TEXT("护甲\n数值：128\n")) + GameXXKCardPillText::DescribeTerm(TEXT("护甲")));
	...
	for (const FExpectedStatusTooltip& Expected : ExpectedStatuses)
	{
		...
		TestEqual(*FString::Printf(TEXT("%s has the approved concise rule"), *Label), Style.Tooltip, GameXXKCardPillText::DescribeTerm(Expected.DisplayName));
		...
		TestTrue(*FString::Printf(TEXT("%s tooltip retains the uncapped real layer"), *Label), Tooltip.Contains(TEXT("：128")));

...
namespace GameXXKHeroCardCatalogTest
{
	...
	const TArray<FExpectedHeroCard>& ExpectedHeroCards()
	{
		static const TArray<FExpectedHeroCard> Expected = {
			...
			{TEXT("Hero.Mage.YanXuLiaoYuan"), EGameXXKCharacterRole::Sorcerer, 1, 1, 3, EGameXXKCardTargetMode::SingleEnemy, 3, 0, 0, false, EGameXXKHeavyArrowKind::None, EGameXXKHeroSpellTaskReward::Fire},
			{TEXT("Hero.Mage.HanXuNingChuan"), EGameXXKCharacterRole::Sorcerer, 1, 0, 0, EGameXXKCardTargetMode::Self, 3, 0, 0, false, EGameXXKHeavyArrowKind::None, EGameXXKHeroSpellTaskReward::Ice},
			{TEXT("Hero.Mage.LeiXuYinTing"), EGameXXKCharacterRole::Sorcerer, 1, 1, 3, EGameXXKCardTargetMode::SingleEnemy, 3, 0, 0, false, EGameXXKHeavyArrowKind::None, EGameXXKHeroSpellTaskReward::Lightning},

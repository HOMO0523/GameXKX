...
namespace GameXXKSorcererPartnerCatalogTest
{
	...
	const TArray<FExpectedCard>& ExpectedCards()
	{
		static const TArray<FExpectedCard> Cards = {
			...
			{TEXT("Profession.Sorcerer.LiHuoYin"), TEXT("灵火点灯"), 1, 1, EGameXXKCardTargetMode::AllEnemies, false,
			...
			{TEXT("Profession.Sorcerer.YanQiang"), TEXT("流焰传薪"), 1, 2, EGameXXKCardTargetMode::AllEnemies, false,
			...
			{TEXT("Profession.Sorcerer.BaoYanShu"), TEXT("焚脉爆炎"), 1, 4, EGameXXKCardTargetMode::AllEnemies, false,
			...
			{TEXT("Profession.Sorcerer.FenMaiFu"), TEXT("玄冰拓脉"), 1, 0, EGameXXKCardTargetMode::Self, false,
			...
			{TEXT("Profession.Sorcerer.LingYanLianDan"), TEXT("霜镜叠甲"), 1, 0, EGameXXKCardTargetMode::Self, false,
			...
			{TEXT("Profession.Sorcerer.ChiXiaoFenXing"), TEXT("引雷定标"), 1, 1, EGameXXKCardTargetMode::AllEnemies, false,
			...
			{TEXT("Profession.Sorcerer.NingYanChengRen"), TEXT("连霆穿云"), 1, 3, EGameXXKCardTargetMode::AllEnemies, false,
			...
			{TEXT("Profession.Sorcerer.RanLingHuanYuan"), TEXT("雷走八方"), 1, 4, EGameXXKCardTargetMode::AllEnemies, false,
			...
			{TEXT("Profession.Sorcerer.YanMuHuTi"), TEXT("万法归一"), 1, 5, EGameXXKCardTargetMode::AllEnemies, false,
			...
			{TEXT("Profession.Sorcerer.XingHuoHuiShou"), TEXT("六合护法"), 1, 4, EGameXXKCardTargetMode::AllAllies, false,
			...
			{TEXT("Profession.Sorcerer.ChiYanFengJie"), TEXT("斗转星移"), 1, 2, EGameXXKCardTargetMode::AllEnemies, false,

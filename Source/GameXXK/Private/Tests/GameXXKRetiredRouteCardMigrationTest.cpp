...
bool FGameXXKRetiredRouteCardMigrationTest::RunTest(const FString& Parameters)
{
	...
	TestEqual(TEXT("enemy phases are current schema v36"), FGameXXKSaveMigration::CurrentSaveVersion, 36);
	...
	TestEqual(TEXT("retirement migration writes v36"), Migrated.SaveVersion, 36);

...
bool FGameXXKHeroCardPoolV12Test::RunTest(const FString& Parameters)
{
	...
	TestEqual(TEXT("the current save version includes named-NPC equipment ownership"), FGameXXKSaveMigration::CurrentSaveVersion, 22);
	...
	TestEqual(TEXT("migration writes the current save version"), ActiveMigratedA.SaveVersion, FGameXXKSaveMigration::CurrentSaveVersion);

...
bool FGameXXKHeroCardPoolV12Test::RunTest(const FString& Parameters)
{
	...
	TestEqual(TEXT("the current save version is nineteen"), FGameXXKSaveMigration::CurrentSaveVersion, 19);
	...
	TestEqual(TEXT("migration writes version nineteen"), ActiveMigratedA.SaveVersion, 19);

...
bool FGameXXKHeroCardPoolV12Test::RunTest(const FString& Parameters)
{
	...
	TestEqual(TEXT("the current save version is twelve"), FGameXXKSaveMigration::CurrentSaveVersion, 12);
	...
	TestEqual(TEXT("migration writes version twelve"), ActiveMigratedA.SaveVersion, 12);

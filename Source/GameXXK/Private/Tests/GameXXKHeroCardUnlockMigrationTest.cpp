...
bool FGameXXKHeroCardPoolV12Test::RunTest(const FString& Parameters)
{
	...
	TestEqual(TEXT("the current save version is eighteen"), FGameXXKSaveMigration::CurrentSaveVersion, 18);
	...
	TestEqual(TEXT("migration writes version eighteen"), ActiveMigratedA.SaveVersion, 18);

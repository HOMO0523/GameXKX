...
namespace
{
	...
	const TArray<FExpectedQuality>& GetExpectedCardQualities()
	{
		static const TArray<FExpectedQuality> Expected = {
			...
			{ TEXT("Profession.Blade.YiShangHuanShi"), EGameXXKCardQuality::Common },
			...
			{ TEXT("Profession.Blade.CanYueSanDie"), EGameXXKCardQuality::Epic },
			...
			{ TEXT("Profession.Blade.XiaoJiaLianJi"), EGameXXKCardQuality::Rare },
			{ TEXT("Profession.Blade.PoLangTuJin"), EGameXXKCardQuality::Common },
			{ TEXT("Profession.Blade.DaoYiShouShu"), EGameXXKCardQuality::Rare },

...
out = Path(unreal.Paths.project_dir()) / 'Saved/FirstBattleGuide-20260916'
out.mkdir(exist_ok=True)
if action == 'quit':
    unreal.SystemLibrary.quit_editor()
    raise SystemExit(0)
assert 'FirstBattleGuide-20260916' in unreal.Paths.project_saved_dir(), 'Review requires isolated profile'

...
IMPORTS = [
    ...
    (SOURCE_DIR / "item_wooden_sword.png", "T_ItemWoodenSword"),
    (SOURCE_DIR / "item_starter_cloth_armor.png", "T_ItemStarterClothArmor"),
    (SOURCE_DIR / "item_cloth_talisman.png", "T_ItemClothTalisman"),
...
def import_texture(source: Path, asset_name: str) -> str:
    ...
    if isinstance(existing_texture, unreal.Texture2D):
        ...
        save_asset_with_texture_budget(existing_texture)

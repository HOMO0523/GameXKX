...
meta['tooltip_typography']=dict(card_name='22px heavy',target_line='14px bold',body='13px')
...
readme.insert(10,'- 字体层级：卡名22号并加重，对象名14号加粗，正文13号；游戏共享说明框的交互与排版已接入，逐卡数值正文仍在后续实装范围。')

...
**Approved Mage Energy budget:** use `docs/superpowers/specs/2026-09-03-sorcerer-energy-cost-design.md`: two zero-cost partner cards, sixteen one-cost partner cards, and Hero Mage 1/1/1/0. Damage-only fixtures must seed their stated budget: 六合 Ice starter and 照见 Ice variants need 4, 斗转 Ice variants need 5, native four-Lightning plus 周天 needs 4, most Universal four-Lightning builds need 5. Refunds arrive after all active payments. Full battles use actual shared base 3 plus real bonuses, gains, discounts and penalties, not fixture-only extra Energy. Preserve partial tasks with real round-start Armor clearing, Mana recovery and enemy actions. Observe reliance on 周天/照见, setup-card value and Hero/partner/NPC budget sharing. Cost approval does not freeze 雷走 candidate Attack coefficients or 引雷 reward changes.
